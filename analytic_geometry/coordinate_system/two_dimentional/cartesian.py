"""2D Cartesian coordinate system point implementation."""
...
class CartesianPoint_2d(BaseModel, CoordinatePoint):
    """
    ...
    def to_cartesian(self) -> CartesianPoint_2d:
        ...
        Returns:
            CartesianPoint_2d: This instance.
        """
        return self
    ...
    def visualize(self) -> None:
        """
        Visualize the point in 2D Cartesian space.
    ...
    def visualize_in_cartesian(self) -> None:
        ...
        For 2D Cartesian points, this is identical to `visualize()`.
        """
        self.visualize()
